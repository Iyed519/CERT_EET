...
Il interagit avec la plateforme à la fois en mode **autonome** (QCM, livrables) et en mode **consultatif** (feedback formateur, certificats, historique).
...
**Pas d'interaction conversationnelle** : l'apprenant ne peut pas répondre directement au feedback — pour toute question, il doit utiliser les canaux de communication externes (Teams, e-mail).
...
3. Le PDF contient :
   ...
   - La **signature institutionnelle ESPRIT Entreprise** (organisme émetteur)
...
*Fin du document — UC Apprenant · Cert_EET v2.0*
